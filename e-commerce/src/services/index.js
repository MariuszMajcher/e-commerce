...
app.post('/sell-cat', (req, res) => {
    const { userId, price, gender, age, breedId, imagesPath, name } = req.body;
    pool.query('INSERT INTO cats_for_sale ( user_id, price, gender, age, breed_id, images_path, name) VALUES ($1, $2, $3, $4, $5, $6, $7)', [ userId, price, gender, age, breedId, imagesPath, name], (err, result) => {
        if (err) {
            return res.status(500).json({ message: err });
        }
